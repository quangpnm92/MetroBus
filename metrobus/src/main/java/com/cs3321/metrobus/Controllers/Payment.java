...
public class Payment {
    public boolean processPayment (PaymentInfo payment, double price, Date today)
    {   
...
//        }
//        
//        int a = date_exp.compareTo(today);
...
//        if (payment.getExpireDate().length() <= 3 || payment.getExpireDate().isBlank() || date_exp.compareTo(today) < 0)
//            return false;
    ...
    public static void main(String[] args) {
        ...
        PaymentInfo payment = new PaymentInfo("4567898751212548", "Quang", "01-01-2022", "456", 30000);
        a.checkCard(payment, 34000);
    }
}
